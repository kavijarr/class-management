    ...
    <div class="white-box">
      ...
      <form method="post" role="form" id="loginform" class="form-horizontal form-material" action="<?php echo base_url();?>login/validate_login">
        ...
        <div class="form-group text-center m-t-20">
          <div class="col-xs-12">
            <a href="../index.html">
              <button class="btn btn-primary btn-rounded btn-sm btn-block text-uppercase waves-effect waves-light" type="button" style="width:100%; color:white">
                <?php echo get_phrase('go_to_homepage');?>
              </button>
            </a>
          </div>
        </div>
        ...
        <div class="form-group text-center m-t-20">
          <div class="col-xs-6">
            <a href="<?php echo base_url();?>">
              <button class="btn btn-info btn-rounded btn-sm text-uppercase" type="button" style="color:white">
                <i class="fa fa-mail-reply-all"></i>&nbsp;<?php echo get_phrase('back_to_login');?>
              </button>
            </a>
            <button class="btn btn-success btn-rounded btn-sm text-uppercase" type="submit" style="color:white">
              <i class="fa fa-key"></i>&nbsp;<?php echo get_phrase('reset_password');?>
            </button>
          </div>
        </div>
